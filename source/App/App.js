        ...
        <div className={css.wrapper}>
          ...
          <div className={css.form + ' ' + css.dark}>
            ...
            <div className={css.flexRow}>
              <Select placeholder='Select an IDE from this list' items={data.ides} onChange={this.onChange}
                defaultItem={{
                  value: 'aptana',
                  label: 'Aptana'
                }} classes={{
            ...
            <div className={css.flexRow}>
              <Select placeholder='Select a language' items={data.programmingLanguages} onChange={this.onChange}
                classes={{
                  title: 'dark-title',
                  itemContainer: 'dark-item-container',
                  item: 'dark-item'
            ...
            <div className={css.flexRow}>
              <Select placeholder=' ' items={data.fontSizes} onChange={this.onChange}
                defaultItem={{
                  value: '14',
                  label: '14px'
                }} classes={{
